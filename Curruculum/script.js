document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupEventListeners() {
        ...
        userForm.addEventListener('submit', (event) => {
            ...
            if (noExperienceCheckbox.checked) { userProfile.experience.push({ noExperience: true }); } else { document.querySelectorAll('#experience-container .form-entry-group').forEach(group => { const title = group.querySelector('.experience-title').value; if (title.trim()) { userProfile.experience.push({ title: title, company: group.querySelector('.experience-company').value, startYear: group.querySelector('.experience-start-year').value, endYear: group.querySelector('.experience-end-year').value }); } }); }
