document.addEventListener('DOMContentLoaded', () => {
    ...
    // (Esta sección está completa y funciona)
    ...
    // --- FUNCIÓN RENDERPREVIEW (ACTUALIZADA CON LA SOLUCIÓN) ---
    async function renderPreview(profile) {
        ...
        try {
            ...
            // Le decimos al iframe cuál es su "dirección base" antes de escribir el contenido.
            const basePath = new URL(templateUrl, window.location.href).href;
            doc.write(`<base href="${basePath}">`);
